            ...
            Item {
                ...
                ColumnLayout {
                    ...
                    ListView {
                        ...
                        model: ListModel {
                            ListElement { version: "v1.7.75"; title: "Housekeeping: .ai/ removed from repo, kept locally only"; desc: "AI memory now lives at ~/WifeRice-Agent-AI.md, never pushed to remote"; icon: "󰋼"; clr: "blue"; detail: "CLEANUP: .ai/ directory removed from git tracking and added to .gitignore. AI memory, rules, session logs, and development guide now live exclusively at ~/WifeRice-Agent-AI.md (local machine only). No AI artifacts ever get pushed to the remote repo." }
